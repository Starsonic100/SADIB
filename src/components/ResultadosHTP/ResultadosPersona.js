...
export class ResultadosPersona extends React.Component {
            ...
            <div className='main'>
                         ...
                         <div className="formulario">
                             ...
                             <div className="instrucciones">
                                     <Typography variant="h5" gutterBottom>Interpretación-Dibujo de Persona</Typography>
                             </div>
                             ...
                             <Typography variant="h5" gutterBottom>{"Rasgos normales"}</Typography>
                                         ...
                                         <li><Typography variant="h6" gutterBottom class="tamai">Observaciones</Typography></li>
                                            ...
                                            <button class="button-ant"onClick={this.regresar}><img src={anterior}/></button>
