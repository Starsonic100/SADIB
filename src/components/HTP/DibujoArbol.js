...
export class DibujoArbol extends Component {
    ...
    render(){
        ...
        const Drawing = () => {
            ...
            const uploadFile = () => {
                let resizedCanvas = document.createElement("canvas");
                let resizedContext = resizedCanvas.getContext("2d");
                dibujos('bDa',resizeCanvas.toDataURL());
                resizedCanvas.height = "250";
                resizedCanvas.width = "250";
                let canvas=document.getElementById("canvas");
                resizedContext.drawImage(canvas, 0, 0, 250, 250);
                ...
                Axios({
                    url: 'http://54.144.147.250:3001/dibujoArbol',
                    method: "POST",
                    data: fd,
                    headers: {
            ...
            async function predecir() {
                ...
                if(mayorIndice==0){
                   dibujos('rDa','Autocontrol');
                  console.log('Autocontrol');                
                }else if(mayorIndice==1){
                   dibujos('rDa','Inseguridad');
